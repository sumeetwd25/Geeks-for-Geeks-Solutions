<h2><a href="https://practice.geeksforgeeks.org/problems/remainder-evaluation3755/1?page=3&difficulty[]=-2&sortBy=submissions">Remainder Evaluation</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two positive integers <strong>num1</strong> and <strong>num2</strong>, the task is to find&nbsp;the remainder when num1&nbsp;is divided by num2.</span></p>
